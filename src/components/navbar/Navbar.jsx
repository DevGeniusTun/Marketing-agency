...
const Navbar = () => {
  ...
  <div className={ sidebar ? "navbar-container active" : "navbar-container" } >
      ...
      <img className={sidebar ?'navbar-logo active' :'navbar-logo' } src={logo}></img>
        ...
        <i className="uil uil-estate nav__icon"></i>Who we are ?</a></li>
        ...
        <li className="navbar-items"><a className={activated[2]} href='#work' onClick={()=>setActivated(["","","active","","","",""])}> <i className="uil uil-scenery nav__icon"></i> Blogs</a></li>
        <li className="navbar-items"><a className={activated[3]} href='#work' onClick={()=>setActivated(["","","","active","","",""])}> <i className="uil uil-scenery nav__icon"></i>Products</a></li>
        <li className="navbar-items"><a className={activated[4]} href="#contact" onClick={()=>setActivated(["","","","","active",""])}><i className="uil uil-user nav__icon"></i> Contact</a></li>
